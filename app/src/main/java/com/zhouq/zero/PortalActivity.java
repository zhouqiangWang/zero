...
public class PortalActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
  ...
  /**
   * This is container for all activities.
   */
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    // TODO: add portal to every Activity here
    activities.add(AsyncTestActivity.class);
    ...
    for(int i = 0; i<activities.size(); i++){
      navMenu.add(R.id.nav_menu_group_top, i, 100, activities.get(i).getSimpleName());
    }
