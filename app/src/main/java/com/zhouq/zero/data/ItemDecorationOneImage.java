...
/**
 * Created by tucker on 16/10/4.
 */

public class ItemDecorationOneImage extends RecyclerView.ItemDecoration {
  ...
  public ItemDecorationOneImage(Context context, int orientation) {
   ...
   */
  public ItemDecorationOneImage(Context context, int orientation, Drawable dividerDrawable) {
